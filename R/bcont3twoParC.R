...
p1 <- p2 <- pdf1 <- pdf2 <- c.copula.be2 <- c.copula.be1 <- c.copula2.be1be2 <- NA
  ...
  if(is.null(VC$X3)){  
    ...
    nu1.st     <- etan1 <- params[(VC$X1.d2 + VC$X2.d2 + 3)]
    nu2.st     <- etan2 <- params[(VC$X1.d2 + VC$X2.d2 + 4)]   
    nu.st      <- etan  <- params[(VC$X1.d2 + VC$X2.d2 + 5)] 
    teta.st    <- etad  <- params[(VC$X1.d2 + VC$X2.d2 + 6)]
  } 
  ...
  if(!is.null(VC$X3)){  
    ...
    nu1.st     <- etan1 <- VC$X5%*%params[(VC$X1.d2 + VC$X2.d2 + VC$X3.d2 + VC$X4.d2 + 1):(VC$X1.d2 + VC$X2.d2 + VC$X3.d2 + VC$X4.d2 + VC$X5.d2)]
    nu2.st     <- etan2 <- VC$X6%*%params[(VC$X1.d2 + VC$X2.d2 + VC$X3.d2 + VC$X4.d2 + VC$X5.d2 + 1):(VC$X1.d2 + VC$X2.d2 + VC$X3.d2 + VC$X4.d2 + VC$X5.d2 + VC$X6.d2)]
    nu.st      <- etan  <- VC$X7%*%params[(VC$X1.d2 + VC$X2.d2 + VC$X3.d2 + VC$X4.d2 + VC$X5.d2 + VC$X6.d2 + 1):(VC$X1.d2 + VC$X2.d2 + VC$X3.d2 + VC$X4.d2 + VC$X5.d2 + VC$X6.d2 + VC$X7.d2)]
    teta.st    <- etad  <- VC$X8%*%params[(VC$X1.d2 + VC$X2.d2 + VC$X3.d2 + VC$X4.d2 + VC$X5.d2 + VC$X6.d2 + VC$X7.d2 + 1):(VC$X1.d2 + VC$X2.d2 + VC$X3.d2 + VC$X4.d2 + VC$X5.d2 + VC$X6.d2 + VC$X7.d2 + VC$X8.d2)]
  }  
...
##################
  ...
  dHs1 <- distrHs(respvec$y1, eta1, sigma21, sigma21.st, nu1, nu1.st, margin2=VC$margins[1], naive = FALSE, min.dn = VC$min.dn, min.pr = VC$min.pr, max.pr = VC$max.pr, left.trunc = VC$left.trunc1)
  dHs2 <- distrHs(respvec$y2, eta2, sigma22, sigma22.st, nu2, nu2.st, margin2=VC$margins[2], naive = FALSE, min.dn = VC$min.dn, min.pr = VC$min.pr, max.pr = VC$max.pr, left.trunc = VC$left.trunc2)
...
##################
 ...
 BITS <- copgHsCont(p1, p2, teta, teta.st, VC$BivD, Cont = TRUE, par2 = nu, nu.st = nu.st)
   ...
   dl.dnu1.st     <- VC$weights*( derpdf1.dernu1.st/pdf1 + derc.dernu1.st/c.copula2.be1be2  )
...
der2c.derp2.dernu  <- BITS$der2c.derp2.dernu
  ...
  d2l.nu1.nu1  <- -VC$weights*( (der2pdf1.dernu1.st2 * pdf1 - derpdf1.dernu1.st^2) / pdf1^2   + 
                            ((der2c.derp1.derp1*derp1.dernu1.st^2+der2h.derp1p1*der2p1.dernu1.st2)*c.copula2.be1be2 - derc.dernu1.st^2) /c.copula2.be1be2^2 )  
  ...
  d2l.be1.nu1  <- -VC$weights*( (der2pdf1.dereta1dernu1.st * pdf1 - derpdf1.dereta1*derpdf1.dernu1.st) / pdf1^2   + 
                         ((der2c.derp1.derp1 * derp1.dereta1* derp1.dernu1.st+der2h.derp1p1*der2p1.dereta1dernu1.st) * c.copula2.be1be2 - derc.dereta1*derc.dernu1.st) /c.copula2.be1be2^2 )
  ...
  d2l.be2.nu1 <- -VC$weights*( (der2c.derp1.derp2*derp2.dereta2*derp1.dernu1.st* c.copula2.be1be2 - derc.dereta2*derc.dernu1.st)/c.copula2.be1be2^2)
  ...
  d2l.rho.nu1 <-  -VC$weights*( (der2c.derp1.derrho*derp1.dernu1.st*derteta.derteta.st*c.copula2.be1be2 - derc.dernu1.st*der2h.derp1teta *derteta.derteta.st)/c.copula2.be1be2^2 )
  ...
  d2l.nu1.nu2 <- -VC$weights*( (der2c.derp1.derp2*derp1.dernu1.st*derp2.dernu2.st* c.copula2.be1be2 - derc.dernu1.st*derc.dernu2.st ) /c.copula2.be1be2^2 )

  d2l.sigma22.nu1 <- -VC$weights*( (der2c.derp1.derp2*derp2.dersigma22.st*derp1.dernu1.st* c.copula2.be1be2 - derc.dersigma22.st*derc.dernu1.st)/c.copula2.be1be2^2)
  ...
  d2l.sigma21.nu1  <- -VC$weights*( (der2pdf1.dersigma21.stdernu1.st * pdf1 - derpdf1.dersigma21.st*derpdf1.dernu1.st) / pdf1^2   + 
                          ((der2c.derp1.derp1 * derp1.dersigma21.st* derp1.dernu1.st+der2h.derp1p1*der2p1.dersigma21.stdernu1.st) * c.copula2.be1be2 - derc.dersigma21.st*derc.dernu1.st) /c.copula2.be1be2^2 )
...
d2l.nu.nu1 <-  -VC$weights*( (der2c.derp1.dernu*derp1.dernu1.st*dernu.dernu.st*c.copula2.be1be2 - derc.dernu1.st*der2h.derp1nu *dernu.dernu.st)/c.copula2.be1be2^2 )
...
if( is.null(VC$X3) ){
  ...
  be1.nu1     <- t(t(rowSums(t(VC$X1*c(d2l.be1.nu1))))) 
  ...
  be2.nu1     <- t(t(rowSums(t(VC$X2*c(d2l.be2.nu1))))) 
  ...
  H <- rbind( cbind(     be1.be1    , be1.be2        ,   be1.sigma21,            be1.sigma22,              be1.nu1,              be1.nu2,              be1.nu, be1.rho  ), 
              cbind( t(be1.be2)     , be2.be2        ,   be2.sigma21,            be2.sigma22,              be2.nu1,              be2.nu2,              be2.nu,  be2.rho  ), 
              cbind( t(be1.sigma21) , t(be2.sigma21) , sum(d2l.sigma21.sigma21), sum(d2l.sigma21.sigma22), sum(d2l.sigma21.nu1), sum(d2l.sigma21.nu2), sum(d2l.nu.sigma21), sum(d2l.rho.sigma21)),
              cbind( t(be1.sigma22) , t(be2.sigma22) , sum(d2l.sigma21.sigma22), sum(d2l.sigma22.sigma22), sum(d2l.sigma22.nu1), sum(d2l.sigma22.nu2), sum(d2l.nu.sigma22), sum(d2l.rho.sigma22)),
              cbind( t(be1.nu1)     , t(be2.nu1)     , sum(d2l.sigma21.nu1),     sum(d2l.sigma22.nu1),     sum(d2l.nu1.nu1),     sum(d2l.nu1.nu2),     sum(d2l.nu.nu1),     sum(d2l.rho.nu1)),
              cbind( t(be1.nu2)     , t(be2.nu2)     , sum(d2l.sigma21.nu2),     sum(d2l.sigma22.nu2),     sum(d2l.nu1.nu2),     sum(d2l.nu2.nu2),     sum(d2l.nu.nu2), sum(d2l.rho.nu2)),
              cbind( t(be1.nu)      ,    t(be2.nu)   ,    sum(d2l.nu.sigma21),   sum(d2l.nu.sigma22),      sum(d2l.nu.nu1),      sum(d2l.nu.nu2),      sum(d2l.nu.nu),  sum(d2l.rho.nu) ),
              cbind( t(be1.rho)     ,   t(be2.rho)   ,   sum(d2l.rho.sigma21),   sum(d2l.rho.sigma22),     sum(d2l.rho.nu1),     sum(d2l.rho.nu2),     sum(d2l.rho.nu), sum(d2l.rho.rho) ) 
...
G   <- -c( colSums(       c(dl.dbe1)*VC$X1 ) ,
           ...
           colSums(    c(dl.dnu1.st)*VC$X5 ) ,
           colSums(    c(dl.dnu2.st)*VC$X6 ) ,
           colSums(     c(dl.dnu.st)*VC$X7 ) ,
           colSums(   c(dl.dteta.st)*VC$X8 )  )  

                 
    be1.be1         <- crossprod(VC$X1*c(d2l.be1.be1),VC$X1)
    be2.be2         <- crossprod(VC$X2*c(d2l.be2.be2),VC$X2)
    be1.be2         <- crossprod(VC$X1*c(d2l.be1.be2),VC$X2)
    be1.rho         <- crossprod(VC$X1*c(d2l.be1.rho),VC$X8)    
    be2.rho         <- crossprod(VC$X2*c(d2l.be2.rho),VC$X8)   
    be1.sigma21     <- crossprod(VC$X1*c(d2l.be1.sigma21),VC$X3)      
    be1.sigma22     <- crossprod(VC$X1*c(d2l.be1.sigma22),VC$X4) 
    
    be1.nu1     <- crossprod(VC$X1*c(d2l.be1.nu1),VC$X5)      
    be1.nu2     <- crossprod(VC$X1*c(d2l.be1.nu2),VC$X6)  
    
    be2.nu1  <- crossprod(VC$X2*c(d2l.be2.nu1),VC$X5)   
    be2.nu2   <- crossprod(VC$X2*c(d2l.be2.nu2),VC$X6)  
    ...
    nu1.nu1 <- crossprod(VC$X5*c(d2l.nu1.nu1),VC$X5)  
    nu2.nu2 <- crossprod(VC$X6*c(d2l.nu2.nu2),VC$X6)
    
    sigma21.sigma22 <- crossprod(VC$X3*c(d2l.sigma21.sigma22),VC$X4)
    
    nu1.nu2 <- crossprod(VC$X5*c(d2l.nu1.nu2),VC$X6)


    rho.sigma21     <- crossprod(VC$X3*c(d2l.rho.sigma21),VC$X8)
    
    rho.nu1     <- crossprod(VC$X5*c(d2l.rho.nu1),VC$X8)
    rho.nu2     <- crossprod(VC$X6*c(d2l.rho.nu2),VC$X8)

    sigma22.sigma22 <- crossprod(VC$X4*c(d2l.sigma22.sigma22),VC$X4)
    rho.sigma22     <- crossprod(VC$X4*c(d2l.rho.sigma22),VC$X8)   
    rho.rho         <- crossprod(VC$X8*c(d2l.rho.rho),VC$X8) 
    
    sigma21.nu1 <- crossprod(VC$X3*c(d2l.sigma21.nu1),VC$X5)
    sigma21.nu2 <- crossprod(VC$X3*c(d2l.sigma21.nu2),VC$X6)

    sigma22.nu2 <- crossprod(VC$X4*c(d2l.sigma22.nu2),VC$X6)
    sigma22.nu1 <- crossprod(VC$X4*c(d2l.sigma22.nu1),VC$X5)
    
   nu.sigma21  <- crossprod(VC$X3*c(d2l.nu.sigma21),VC$X7) 
   nu.sigma22  <- crossprod(VC$X4*c(d2l.nu.sigma22),VC$X7)
   nu.nu1      <- crossprod(VC$X5*c(d2l.nu.nu1),VC$X7) 
   nu.nu2      <- crossprod(VC$X6*c(d2l.nu.nu2),VC$X7)
   nu.nu       <- crossprod(VC$X7*c(d2l.nu.nu),VC$X7)
   rho.nu      <- crossprod(VC$X7*c(d2l.rho.nu),VC$X8)
 
    be1.nu     <- crossprod(VC$X1*c(d2l.be1.nu),VC$X7)
   be2.nu      <- crossprod(VC$X2*c(d2l.be2.nu),VC$X7)
    ...
    H <- rbind( cbind( be1.be1        ,   be1.be2      ,   be1.sigma21     , be1.sigma22    , be1.nu1    , be1.nu2    , be1.nu, be1.rho    ), 
                cbind( t(be1.be2)     ,   be2.be2      ,   be2.sigma21     , be2.sigma22    , be2.nu1    , be2.nu2    , be2.nu, be2.rho    ), 
                cbind( t(be1.sigma21) , t(be2.sigma21) ,   sigma21.sigma21 , sigma21.sigma22, sigma21.nu1, sigma21.nu2, nu.sigma21, rho.sigma21),
                cbind( t(be1.sigma22) , t(be2.sigma22) , t(sigma21.sigma22), sigma22.sigma22, sigma22.nu1, sigma22.nu2, nu.sigma22, rho.sigma22),
                cbind( t(be1.nu1)     , t(be2.nu1)     , t(sigma21.nu1)    , t(sigma22.nu1) , nu1.nu1    , nu1.nu2    , nu.nu1, rho.nu1    ),
                cbind( t(be1.nu2)     , t(be2.nu2)     , t(sigma21.nu2)    , t(sigma22.nu2) , t(nu1.nu2) , nu2.nu2    , nu.nu2, rho.nu2    ),
                
                cbind( t(be1.nu)      ,    t(be2.nu)   ,    t(nu.sigma21),   t(nu.sigma22),   t(nu.nu1),  t(nu.nu2),     nu.nu,      rho.nu ),
                
                
                cbind( t(be1.rho)     ,   t(be2.rho)   , t(rho.sigma21)    , t(rho.sigma22) , t(rho.nu1) , t(rho.nu2) , t(rho.nu), rho.rho    )  ) 
