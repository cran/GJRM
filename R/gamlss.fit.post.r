...
if( is.null(VC$X2) ) names(sigma2) <- "sigma2"
...
sp <- SemiParFit$sp 
                 ...
                 list(SemiParFit = SemiParFit, He = He, logLik = logLik, Vb = Vb, Vb.t = Vb.t, HeSh = HeSh, 
                      ...
                      sigma2 = sigma2, sigma2.a = sigma2.a, nu = nu, nu.a = nu.a, sp = sp, 
