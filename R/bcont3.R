...
if( is.null(VC$X3) ){
  ...
  H <- rbind( cbind( be1.be1    ,   be1.be2    ,   be1.sigma21,    be1.sigma22, be1.nu1,    be1.nu2,      be1.rho  ), 
              cbind( t(be1.be2) ,   be2.be2    ,   be2.sigma21,    be2.sigma22, be2.nu1,    be2.nu2,       be2.rho  ), 
              cbind( t(be1.sigma21) , t(be2.sigma21) , sum(d2l.sigma21.sigma21), sum(d2l.sigma21.sigma22), sum(d2l.sigma21.nu1),sum(d2l.sigma21.nu2), sum(d2l.rho.sigma21)),
              cbind( t(be1.sigma22) , t(be2.sigma22) , sum(d2l.sigma21.sigma22), sum(d2l.sigma22.sigma22),sum(d2l.sigma22.nu1), sum(d2l.sigma22.nu2), sum(d2l.rho.sigma22)),
              cbind( t(be1.nu1) , t(be2.nu1) , sum(d2l.sigma21.nu1), sum(d2l.sigma22.nu1),sum(d2l.nu1.nu1), sum(d2l.nu1.nu2), sum(d2l.rho.nu1)),
              cbind( t(be1.nu2) , t(be2.nu2) , sum(d2l.sigma21.nu2), sum(d2l.sigma22.nu2),sum(d2l.nu1.nu2), sum(d2l.nu2.nu2), sum(d2l.rho.nu2)),
              cbind( t(be1.rho) ,   t(be2.rho) ,   sum(d2l.rho.sigma21), sum(d2l.rho.sigma22), sum(d2l.rho.nu1), sum(d2l.rho.nu2), sum(d2l.rho.rho) ) 
...
G   <- -c( colSums(       c(dl.dbe1)*VC$X1 ) ,
    ...
    rho.nu1     <- crossprod(VC$X5*c(d2l.rho.nu1),VC$X7)
    rho.nu2     <- crossprod(VC$X6*c(d2l.rho.nu2),VC$X7)
    ...
    H <- rbind( cbind( be1.be1        ,   be1.be2      ,   be1.sigma21,      be1.sigma22, be1.nu1,  be1.nu2,      be1.rho    ), 
                cbind( t(be1.be2)     ,   be2.be2      ,   be2.sigma21,      be2.sigma22, be2.nu1,  be2.nu2,      be2.rho    ), 
                cbind( t(be1.sigma21) , t(be2.sigma21) ,   sigma21.sigma21,  sigma21.sigma22, sigma21.nu1, sigma21.nu2,    rho.sigma21),
                cbind( t(be1.sigma22) , t(be2.sigma22) , t(sigma21.sigma22), sigma22.sigma22, sigma22.nu1, sigma22.nu2,   rho.sigma22),
                
                cbind( t(be1.nu1) , t(be2.nu1) , t(sigma21.nu1), t(sigma22.nu1), nu1.nu1, nu1.nu2,   rho.nu1),
                cbind( t(be1.nu2) , t(be2.nu2) , t(sigma21.nu2), t(sigma22.nu2), t(nu1.nu2), nu2.nu2,   rho.nu2),
                
                cbind( t(be1.rho)     ,   t(be2.rho)   ,   t(rho.sigma21),   t(rho.sigma22), t(rho.nu1),   t(rho.nu2),    rho.rho    ) ) 
