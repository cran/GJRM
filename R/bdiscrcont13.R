bdiscrcont13 <- function(params, respvec, VC, ps, AT = FALSE){
  ...
  if(is.null(VC$X3)){  
    ...
    nu2.st     <- etan2 <- params[(VC$X1.d2 + VC$X2.d2 + 2)]    
 ...
 if(!is.null(VC$X3)){  
    ...
    nu2.st     <- etan2 <- VC$X4%*%params[(VC$X1.d2 + VC$X2.d2 + VC$X3.d2 + 1):(VC$X1.d2 + VC$X2.d2 + VC$X3.d2 + VC$X4.d2)]
...
if( is.null(VC$X3) ){
  ...
  H <- rbind( cbind( be1.be1    ,   be1.be2    ,    be1.sigma22,    be1.nu2,      be1.rho  ), 
              cbind( t(be1.be2) ,   be2.be2    ,     be2.sigma22,    be2.nu2,       be2.rho  ), 
              cbind( t(be1.sigma22) , t(be2.sigma22) , sum(d2l.sigma22.sigma22), sum(d2l.sigma22.nu2), sum(d2l.rho.sigma22)),
              cbind( t(be1.nu2) , t(be2.nu2) , sum(d2l.sigma22.nu2), sum(d2l.nu2.nu2), sum(d2l.rho.nu2)),
              cbind( t(be1.rho) ,   t(be2.rho) , sum(d2l.rho.sigma22), sum(d2l.rho.nu2), sum(d2l.rho.rho) ) 
...
G   <- -c( colSums(       c(dl.dbe1)*VC$X1 ) ,
    ...
    be1.nu2         <- crossprod(VC$X1*c(d2l.be1.nu2),VC$X4)  
    be2.nu2         <- crossprod(VC$X2*c(d2l.be2.nu2),VC$X4)  
    be2.sigma22     <- crossprod(VC$X2*c(d2l.be2.sigma22),VC$X3)   
    nu2.nu2         <- crossprod(VC$X4*c(d2l.nu2.nu2),VC$X4)
    rho.nu2         <- crossprod(VC$X4*c(d2l.rho.nu2),VC$X5)
    sigma22.sigma22 <- crossprod(VC$X3*c(d2l.sigma22.sigma22),VC$X3)
    rho.sigma22     <- crossprod(VC$X3*c(d2l.rho.sigma22),VC$X5)   
    rho.rho         <- crossprod(VC$X5*c(d2l.rho.rho),VC$X5) 
    sigma22.nu2     <- crossprod(VC$X3*c(d2l.sigma22.nu2),VC$X4)
    
    H <- rbind( cbind( be1.be1        ,   be1.be2      ,      be1.sigma22,   be1.nu2,      be1.rho    ), 
                cbind( t(be1.be2)     ,   be2.be2       ,    be2.sigma22,   be2.nu2,      be2.rho    ), 
                cbind( t(be1.sigma22) , t(be2.sigma22), sigma22.sigma22,  sigma22.nu2,   rho.sigma22),
                cbind( t(be1.nu2) , t(be2.nu2) , t(sigma22.nu2), nu2.nu2,   rho.nu2),
                cbind( t(be1.rho)     ,   t(be2.rho)   ,   t(rho.sigma22),    t(rho.nu2),    rho.rho    ) ) 
