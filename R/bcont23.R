bcont23 <- function(params, respvec, VC, ps, AT = FALSE){
...
if( VC$margins[1] == "LN"){
  ...
  dHs1 <- distrHsAT(exp(respvec$y1), eta1, sigma21, 1, margin2=VC$margins[1], min.dn = VC$min.dn, min.pr = VC$min.pr, max.pr = VC$max.pr)
