triprobgHsSS <- function (params, respvec, VC, ps, AT = FALSE){
  ...
  l.par1[VC$inde1]   <- respvec$y1.cy2*log(p10)
  l.par1[VC$inde2]   <- respvec$y1.y2.cy3 * log(p110) + respvec$y1.y2.y3 * log(p111)
